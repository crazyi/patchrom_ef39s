...
.field private static final KEY_MASK_SEARCH:I = 0x8
...
.field static final LONG_PRESS_MENU_NOTHING:I = 0x0

.field static final LONG_PRESS_MENU_SEARCH:I = 0x1
...
.method static synthetic access$000(Lcom/android/internal/policy/impl/PhoneWindowManager;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private handleLongPressOnMenu()V
    ...
    iget v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLongPressOnMenuBehavior:I
...
.method public finishAnimationLw()I
    ...
    const-string v6, "combined_bar_auto_hide"
...
.method handleVolumeKey(II)V
    ...
    :cond_1
    :try_start_1
    invoke-virtual {v0, p1}, Landroid/media/AudioManager;->toggleMute(I)V
    :try_end_1
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;Landroid/os/LocalPowerManager;)V
    ...
    :cond_0
    new-instance v11, Landroid/os/Vibrator;

    invoke-direct {v11}, Landroid/os/Vibrator;-><init>()V
    ...
    const-string v12, "Loaded device key handler"
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    .restart local v23       #timeoutTime:J
    cmp-long v27, v17, v23
    ...
    iget-boolean v0, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAppSwitchPressed:Z
    ...
    iput-boolean v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAppSwitchPressed:Z

    if-nez v3, :cond_19

    if-nez v15, :cond_19

    const-string v27, "recentapps"
    ...
    invoke-interface/range {v27 .. v27}, Lcom/android/internal/statusbar/IStatusBarService;->toggleRecentApps()V
    :try_end_1
    ...
    const-string v28, "kill_app_longpress_back"
    ...
    const-string v28, "Could not dispatch event to device key handler"
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    iput-boolean v10, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownKeyConsumedByChord:Z

    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->cancelPendingPowerKeyAction()V

    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptScreenshotChord()V

    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptRingerChord()V
    ...
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->cancelPendingRingerChordAction()V
    ...
    iput-wide v10, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeUpKeyTime:J

    const/4 v10, 0x0

    iput-boolean v10, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeUpKeyConsumedByChord:Z
    ...
    iget-boolean v10, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolBtnMusicControls:Z
    ...
    iget-boolean v10, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeWakeScreen:Z
...
.method public rotationForOrientationLw(II)I
    ...
    :cond_0
    iget v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLidOpen:I
    ...
    .end local v1           #preferredRotation:I
    :cond_9
    iget v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAccelerometerDefault:I
