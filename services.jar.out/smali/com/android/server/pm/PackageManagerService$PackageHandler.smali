...
.method doHandleMessage(Landroid/os/Message;)V
    ...
    check-cast v26, Lcom/android/server/pm/PackageManagerService$HandlerParams;

    .line 490
    .local v26, params:Lcom/android/server/pm/PackageManagerService$HandlerParams;
    ...
    .line 500
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/pm/PackageManagerService$HandlerParams;->serviceError()V
    ...
    .line 519
    .end local v22           #idx:I
    .end local v26           #params:Lcom/android/server/pm/PackageManagerService$HandlerParams;
    :pswitch_2
    move-object/from16 v0, p1
    ...
    .line 526
    .restart local v26       #params:Lcom/android/server/pm/PackageManagerService$HandlerParams;
    move-object/from16 v0, p0
    ...
    .line 534
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/pm/PackageManagerService$HandlerParams;->startCopy()Z
    ...
    .line 551
    .local v34, ubmsg:Landroid/os/Message;
    ...
    .line 559
    .end local v34           #ubmsg:Landroid/os/Message;
    :cond_7
    move-object/from16 v0, p0
    ...
    .line 631
    .local v23, it:Ljava/util/Iterator;,"Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Ljava/util/ArrayList<Ljava/lang/String;>;>;>;"
    const/16 v20, 0x0
    ...
    .line 634
    .local v19, ent:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;Ljava/util/ArrayList<Ljava/lang/String;>;>;"
    ...
    .line 640
    .end local v19           #ent:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;Ljava/util/ArrayList<Ljava/lang/String;>;>;"
    ...
    .end local v20           #i:I
    .end local v23           #it:Ljava/util/Iterator;,"Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Ljava/util/ArrayList<Ljava/lang/String;>;>;>;"
    .end local v25           #packages:[Ljava/lang/String;
    .end local v32           #size:I
    .end local v35           #uids:[I
    :pswitch_7
    move-object/from16 v0, p1
    ...
    check-cast v15, Lcom/android/server/pm/PackageManagerService$PostInstallData;

    .line 664
    .local v15, data:Lcom/android/server/pm/PackageManagerService$PostInstallData;
    move-object/from16 v0, p0
    ...
    .line 667
    .local v16, deleteOld:Z
    if-eqz v15, :cond_18

    .line 668
    iget-object v12, v15, Lcom/android/server/pm/PackageManagerService$PostInstallData;->args:Lcom/android/server/pm/PackageManagerService$InstallArgs;

    .line 669
    .local v12, args:Lcom/android/server/pm/PackageManagerService$InstallArgs;
    iget-object v0, v15, Lcom/android/server/pm/PackageManagerService$PostInstallData;->res:Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;

    move-object/from16 v29, v0

    .line 671
    .local v29, res:Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;
    ...
    invoke-static/range {v2 .. v7}, Lcom/android/server/pm/PackageManagerService;->sendPackageBroadcast(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;Landroid/content/IIntentReceiver;)V
    ...
    .line 707
    :cond_16
    iget-object v2, v12, Lcom/android/server/pm/PackageManagerService$InstallArgs;->observer:Landroid/content/pm/IPackageInstallObserver;
    ...
    .end local v29           #res:Lcom/android/server/pm/PackageManagerService$PackageInstalledInfo;
    :cond_18
    const-string v2, "PackageManager"
    ...
    .line 720
    .end local v15           #data:Lcom/android/server/pm/PackageManagerService$PostInstallData;
    .end local v16           #deleteOld:Z
    :pswitch_9
    move-object/from16 v0, p1
    ...
    .line 732
    .local v13, args:Ljava/util/Set;,"Ljava/util/Set<Lcom/android/server/pm/PackageManagerService$SdInstallArgs;>;"
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/pm/PackageManagerService$PackageHandler;->this$0:Lcom/android/server/pm/PackageManagerService;

    #calls: Lcom/android/server/pm/PackageManagerService;->unloadAllContainers(Ljava/util/Set;)V
    invoke-static {v2, v13}, Lcom/android/server/pm/PackageManagerService;->access$500(Lcom/android/server/pm/PackageManagerService;Ljava/util/Set;)V

    .line 734
    .end local v13           #args:Ljava/util/Set;,"Ljava/util/Set<Lcom/android/server/pm/PackageManagerService$SdInstallArgs;>;"
    :cond_1a
    if-eqz v28, :cond_0
    ...
    .line 720
    .end local v17           #doGc:Z
    .end local v18           #e:Landroid/os/RemoteException;
    .end local v28           #reportStatus:Z
    :cond_1b
    const/16 v28, 0x0
    ...
    .line 721
    .restart local v28       #reportStatus:Z
    :cond_1c
    const/16 v17, 0x0
    ...
    invoke-virtual {v2}, Lcom/android/server/pm/Settings;->writeStoppedLPr()V
    ...
    check-cast v33, Lcom/android/server/pm/PackageVerificationState;

    .line 764
    .local v33, state:Lcom/android/server/pm/PackageVerificationState;
    if-eqz v33, :cond_0

    .line 765
    invoke-virtual/range {v33 .. v33}, Lcom/android/server/pm/PackageVerificationState;->getInstallArgs()Lcom/android/server/pm/PackageManagerService$InstallArgs;
    ...
    iget-object v6, v12, Lcom/android/server/pm/PackageManagerService$InstallArgs;->packageURI:Landroid/net/Uri;
    ...
    invoke-static {v2, v12, v0}, Lcom/android/server/pm/PackageManagerService;->access$600(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/PackageManagerService$InstallArgs;I)V
    ...
    .end local v12           #args:Lcom/android/server/pm/PackageManagerService$InstallArgs;
    .end local v31           #ret:I
    .end local v33           #state:Lcom/android/server/pm/PackageVerificationState;
    ...
    .line 781
    .restart local v33       #state:Lcom/android/server/pm/PackageVerificationState;
    if-nez v33, :cond_1d
    ...
    check-cast v30, Lcom/android/server/pm/PackageVerificationResponse;

    .line 788
    .local v30, response:Lcom/android/server/pm/PackageVerificationResponse;
    ...
    .line 790
    invoke-virtual/range {v33 .. v33}, Lcom/android/server/pm/PackageVerificationState;->isVerificationComplete()Z
    ...
    .line 796
    .restart local v12       #args:Lcom/android/server/pm/PackageManagerService$InstallArgs;
    invoke-virtual/range {v33 .. v33}, Lcom/android/server/pm/PackageVerificationState;->isInstallAllowed()Z
    ...
    invoke-virtual {v12, v2, v3}, Lcom/android/server/pm/PackageManagerService$InstallArgs;->copyApk(Lcom/android/internal/app/IMediaContainerService;Z)I
    :try_end_c
